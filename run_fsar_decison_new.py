...
from models.cross_domain_fsar_resnet_new import CROSS_DOMAIN_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=10000, help="Path to model to load and test.")
...
class Learner:
    ...
    def train_task(self, task_dict, iteration):
        ...
        if iteration > self.args.start_cross:
            ...
            lambdas = [1, 1, 0.2, 0.1, 0.1, 0.1]
        else:
            lambdas = [1, 0.2, 0.2, 0, 0,0]
