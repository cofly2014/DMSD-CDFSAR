...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_rareAction_ypnm/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_rareAction_ypnm/", help="Path to model to load and test.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=21000, help="Path to model to load and test.")
