...
def parse_command_line():
    ...
    parser.add_argument("--resume_checkpoint_iter", type=int, default=18400, help="Path to model to resume.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=13000, help="Path to model to load and test.")
