...
def parse_command_line():
    ...
    parser.add_argument('--test_iters', nargs='+', type=int, default=[20010], help='iterations to test at. Default is for ssv2 otam split.')
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_diving48_single/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_diving48_single/", help="Path to model to load and test.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=18600, help="Path to model to load and test.")
...
class Learner:
    ...
    def train_task(self, task_dict, iteration):
        ...
        if iteration > self.args.start_cross:
            ...
            lambdas = [1, 1, 0.2, 0, 0]  #upervied+meta + meta 和 supervised蒸馏
