...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_(hmdb_source)_ssv2/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_(hmdb_source)_ssv2/", help="Path to model to load and test.")

    parser.add_argument("--resume_checkpoint_iter", type=int, default=19400, help="Path to model to resume.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=17400, help="Path to model to load and test.")
    ...
    parser.add_argument('--class_num', type=int, default=70, help='the number of class catetories in the training stage')
