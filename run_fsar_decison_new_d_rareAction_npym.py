...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_rareAction_npym/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_rareAction_npym/", help="Path to model to load and test.")

    parser.add_argument("--resume_checkpoint_iter", type=int, default=18600, help="Path to model to resume.")
