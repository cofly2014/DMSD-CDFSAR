...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_(hmdb_source)_rareAction/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_(hmdb_source)_rareAction/", help="Path to model to load and test.")
