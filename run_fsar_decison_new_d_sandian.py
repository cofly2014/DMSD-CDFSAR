...
from models.cross_domain_fsar_resnet_new_d_plot_sandian import CROSS_DOMAIN_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--shot", type=int, default=80, help="Shots per class.")
    ...
    #parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_ssv2_1/", help="Directory to save checkpoint to.")
    #parser.add_argument("--test_model_path", "-m", default="./checkpoint_ssv2_1/", help="Path to model to load and test.")
    #parser.add_argument("--checkpoint_dir", "-c", default="/data1/guofei/Projects/cross-domain-fsar-new/checkpoint_hmdb_ypym/", help="Directory to save checkpoint to.")
    #parser.add_argument("--test_model_path", "-m", default="/data1/guofei/Projects/cross-domain-fsar-new/checkpoint_hmdb_ypym/", help="Path to model to load and test.")
    #parser.add_argument("--checkpoint_dir", "-c", default="/data1/guofei/Projects/cross-domain-fsar-new/checkpoint_hmdb_ypym/", help="Directory to save checkpoint to.")
    #parser.add_argument("--test_model_path", "-m", default="/data1/guofei/Projects/cross-domain-fsar-new/checkpoint_hmdb_ypym/", help="Path to model to load and test.")
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_(hmdb_source)_ucf101/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_(hmdb_source)_ucf101", help="Path to model to load and test.")

    parser.add_argument("--resume_checkpoint_iter", type=int, default=20000, help="Path to model to resume.")
...
class Learner:
    ...
    def train_task(self, task_dict, iteration):
        ...
        if iteration > self.args.start_cross:
            ...
            lambdas = [1, 1, 0.2, 0.2, 0.2]  #upervied+meta + meta 和 supervised蒸馏
            lambdas = [1, 0.2, 0.2, 0.1, 0.1]

        else:
            lambdas = [1, 0, 0.2, 0, 0,0]
