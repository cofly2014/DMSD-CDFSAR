...
from models.cross_domain_fsar_resnet_new_d_backbone import CROSS_DOMAIN_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_backbone/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_backbone/", help="Path to model to load and test.")
...
class Learner:
    ...
    def train_task(self, task_dict, iteration):
        ...
        if iteration > self.args.start_cross:
            lambdas = [1, 1, 0, 0, 0]  #upervied+meta + meta 和 supervised蒸馏
