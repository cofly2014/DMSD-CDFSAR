...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_hmdb_ypym/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_hmdb_ypym/", help="Path to model to load and test.")
