...
def parse_command_line():
    ...
    parser.add_argument("--source_dataset", choices=["ssv2", "ssv2_cmn", "kinetics", "hmdb", "ucf", "diving48", "rareAct"], default="diving48", help="Dataset to use.")
    parser.add_argument("--target_dataset", choices=["ssv2", "ssv2_cmn", "kinetics", "hmdb", "ucf", "diving48", "rareAct"], default="kinetics",       help="Dataset to use.")

    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_(hmdb_source)_kinetics/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_(hmdb_source)_kinetics/", help="Path to model to load and test.")

    parser.add_argument("--resume_checkpoint_iter", type=int, default=10800, help="Path to model to resume.")
