...
from models.cross_domain_fsar_resnet_new_d_noICC import CROSS_DOMAIN_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_diving48_NoICC/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_diving48_NoICC/", help="Path to model to load and test.")
